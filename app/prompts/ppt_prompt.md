...
- Use ``<details open></details>`` for details (if needed)
- Use horizontal rule `---` to separate slides

### Content Formatting
- Use unordered lists (`*` or `-`) for key points
- Use  (`<details open></details>`) for key points details
- Use ordered lists (`1.`, `2.`) for sequential steps
- Use  (`<details open></details>`) for sequential steps details
...
- Key Point 1
  - Key Point 1 
    <details open>Key Point 1 details</details>
- Key Point 2
  <details open>Key Point 12 details</details>
- Key Point 3
  <details open>Key Point 3 details 1</details>
  <details open>Key Point 3 details 2</details>
  <details open>Key Point 3 details 3</details>
...
### Detailed Slide Content Third Level Title
  - Specific bullet points
  - Explanatory details
    <details open>Key Point details 1</details>
    <details open>Key Point details 2</details>
    <details open>Key Point details 3</details>
  - Key takeaways
...
- make sure DO NOT use ** to tag some word, DO NOT DO THIS example: - **报告主题**：2023年深圳市人民政府工作报告阿斯顿发 ； IT MUST BE： - 报告主题：2023年深圳市人民政府工作报告阿斯顿发